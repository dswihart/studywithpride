                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@studywithpride.com</p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{t('contact.whatsappHours')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{t('contact.virtualMeetings')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="text-purple-600 text-2xl">🌐</div>
                    <div>
                      <h3 className="font-semibold text-gray-900">{t('contact.socialMedia')}</h3>
